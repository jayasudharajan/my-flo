...
const (
	...
	TIME_FMT_PUBGW     = "2006-01-02T15:04:05Z"
	TIME_FMT_PUBGW_MS  = "2006-01-02T15:04:05.999Z"
)

// UnmarshalJSON Parses the json string in the custom format
func (ct *DateTime) UnmarshalJSON(b []byte) (err error) {
	defer panicRecover(_log, "DT UnmarshalJSON: %s", b)
...
func (ct *DateTime) Format(fmtStr string) string {
	if ct == nil {
...
func (ct *DateTime) Time() time.Time {
	if ct == nil {
		return time.Time{}
	}
	return time.Time(*ct)
...
func (ct *DateTime) UTC() time.Time {
	return ct.Time().UTC()
}
