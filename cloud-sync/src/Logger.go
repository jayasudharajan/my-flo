...
func (l *Logger) IfFatalF(e error, format string, args ...interface{}) error {
	if e != nil {
		l.Fatal(format+LOG_WRAP_TEMPLATE, append(args, e.Error())...)
	}
	return e
}
...
func (l *Logger) IfErrorF(e error, format string, args ...interface{}) error {
	if e != nil {
		l.Error(format+LOG_WRAP_TEMPLATE, append(args, e.Error())...)
	}
	return e
}
...
func (l *Logger) IfWarnF(e error, format string, args ...interface{}) error {
	if e != nil {
		l.Warn(format+LOG_WRAP_TEMPLATE, append(args, e.Error())...)
	}
	return e
}
