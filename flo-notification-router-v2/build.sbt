...
lazy val projectSettings = Seq(
  ...
  organizationName := "Flo Technologies",
  name := "flo-notification-router-v2"
)
...
lazy val libraryDependenciesSettings = Seq(
...
artifactName := { (sv: ScalaVersion, module: ModuleID, artifact: Artifact) =>
  artifact.extension match {
    case "jar" => "app-assembly.jar"
    case "pom" =>  artifact.name + "-" + module.revision + "." + artifact.extension 
  }
}
...
lazy val floNotificationRouterV2 = (project in file("."))
  .settings(
    projectSettings,
    buildSettings,
    scalaCompilerOptions,
    libraryDependenciesSettings,
    pluginsSettings,
    resolverSettings
  )