...
func (h *S3Handler) UploadFile(ctx context.Context, bucketName string, key string, buffer []byte) error {

	_, err := s3.New(h.Session).PutObjectWithContext(ctx, &s3.PutObjectInput{
