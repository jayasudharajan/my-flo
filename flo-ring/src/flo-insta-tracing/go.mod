module gitlab.com/ctangfbwinn/flo-insta-tracing
...
require (
	...
	github.com/instana/go-sensor/instrumentation/instaawssdk v1.10.0
	github.com/instana/go-sensor/instrumentation/instaecho v1.8.0
	github.com/instana/go-sensor/instrumentation/instagin v1.7.1
	github.com/instana/go-sensor/instrumentation/instamux v1.8.0
