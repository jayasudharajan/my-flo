...
func CreateRedisConnection(log *Logger, cnString string) (*RedisConnection, error) {
...
func (obj *RedisConnection) ZRangeByScoreWithScores(key string, minScore *float64, maxScore *float64, count *int64, offset *int64) ([]redis.Z, error) {
	...
	result := obj._client.ZRangeByScoreWithScores(key, redis.ZRangeBy{
		Min:    minScoreStr,
		Max:    maxScoreStr,
		Count:  countParam,
		Offset: offsetParam,
