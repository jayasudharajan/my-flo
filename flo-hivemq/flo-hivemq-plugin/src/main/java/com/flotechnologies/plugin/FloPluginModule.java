 ...
 */
@Information(name = "Flo HiveMQ Plug-in", author = "Flo Technologies Software Engineering Team", version = "20180705.1")
public class FloPluginModule extends HiveMQPluginModule {

//    @NotNull
//    Logger log = LoggerFactory.getLogger(FloPluginModule.class);
    ...
    protected void configurePlugin() {
        bind(FirebaseDatabase.class).toProvider(FirestoreProvider.class).in(Singleton.class);
    }
