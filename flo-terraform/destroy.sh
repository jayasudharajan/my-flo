...
peering_destroy(){
  pushd "${BASE_PATH}/${ENVIRONMENT}/${TERRAFORM_DIRECTORY}/vpc-peering"
...
kubernetes_destroy(){
  pushd "${BASE_PATH}/${ENVIRONMENT}/${TERRAFORM_DIRECTORY}/kubernetes"
...
base_destroy(){
  ...
  pushd "${BASE_PATH}/${ENVIRONMENT}/${TERRAFORM_DIRECTORY}/base"
