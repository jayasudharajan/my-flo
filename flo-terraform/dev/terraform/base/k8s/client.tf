...
module "kops-bucket-s3" {
  ...
  source = "git::ssh://git@gitlab.com/flotechnologies/devops/terraform-modules.git//s3?ref=kops-tf11-proper"
...
module "vpc" {
  source = "git::ssh://git@gitlab.com/flotechnologies/devops/terraform-modules.git//vpc?ref=kops-tf11-proper"
