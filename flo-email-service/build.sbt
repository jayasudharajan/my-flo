...
libraryDependencies ++= Seq(
	...
	// Email: SendWithUs
	"com.sendwithus" % "java-client" % "1.11.1",
...
resolvers +=
	"Send with us" at "https://nexus.flotech.co/repository/sendwithus-proxy"
...
mainClass in assembly := Some("com.flo.services.email.EmailServiceApplication")
