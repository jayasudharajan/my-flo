...
class SimpleBadge extends StatefulWidget {
  ...
  @override
  SimpleBadgeState createState() {
    return SimpleBadgeState();
  }
}

class SimpleBadgeState extends State<SimpleBadge> with SingleTickerProviderStateMixin {
