...
class DropdownButton2<T> extends StatefulWidget {
  ...
  ///
  /// To use a separate text style for the dropdown button, consider using
  /// [selectedItemBuilder].
  ///
  /// {@tool snippet --template=stateful_widget_scaffold}
  ///
  /// This sample shows a `DropdownButton` with a dropdown button text style
  /// that is unique from its menu items.
  ///
  /// ```dart
...
class _DropdownButtonState<T> extends State<DropdownButton2<T>> with WidgetsBindingObserver {
  int _selectedIndex;
  ...
  void _handleTap() {
    ...
    final Rect itemRect = itemBox.localToGlobal(Offset.zero) & (itemBox.size * 2);
    final TextDirection textDirection = Directionality.of(context);
