...
const ENVVAR_LOCAL_DEBUG = "FLO_LOCAL_DEBUG"
const ENVVAR_LOG_MIN_LEVEL = "FLO_LOG_MIN_LEVEL"
const LOG_PREFIX_DEFAULT = "weekly-post"
...
func DefaultLogger() *Logger {
	...
	log := CreateLogger(LOG_PREFIX_DEFAULT, "", LogLevel(n)).SetColor(isDebug || isLocal)
	log.isDebug = isDebug
	return log
}
