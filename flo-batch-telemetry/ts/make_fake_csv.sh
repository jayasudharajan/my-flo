...
# psql postgres://tsdbadmin:jl60n6blr9vqny9v@tsdb-168dc9d0-flo-dev.a.timescaledb.io:16627/defaultdb?sslmode=require < schema.sql
# psql postgres://tsdbadmin:jl60n6blr9vqny9v@tsdb-168dc9d0-flo-dev.a.timescaledb.io:16627/defaultdb?sslmode=require -c "\COPY water_5min FROM data.csv CSV"
# REFRESH MATERIALIZED VIEW water_hourly; REFRESH MATERIALIZED VIEW water_daily;
# \di+ did_bk_ux
# \di+ bk_ix