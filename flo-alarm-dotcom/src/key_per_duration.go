...
// CreateKeyPerDuration wraps logic: all keys older than this duration will be flushed periodically
...
func (o *keyPerDuration) Reset() {
	o.mux.Lock()
	defer o.mux.Unlock()

	for k, _ := range o.lastMap {
		delete(o.lastMap, k)
	}
}
...
func (o *keyPerDuration) Clear(key string) bool {
	if o == nil {
		return false
	}
	o.mux.Lock()
