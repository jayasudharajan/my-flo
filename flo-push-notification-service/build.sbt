...
lazy val projectSettings = Seq(
  ...
  name := "flo-push-notification-service"
)
...
lazy val assemblySettings = Seq(
  ...
  mainClass in assembly := Some("com.flo.push.PushNotificationServiceApp"),
...
lazy val floPushNotificationService = (project in file("."))
  .settings(
    projectSettings,
    buildSettings,
