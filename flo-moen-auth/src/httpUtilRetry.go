...
func CreateHttpUtilRetry(base HttpUtil, retry canRetryFunc, log *Logger) HttpUtil {
	hr := httpUtilRetry{
		base:      base,
		retry:     retry,
...
func (hr *httpUtilRetry) GetHttpClient() *http.Client {
	return hr.base.GetHttpClient()
}
