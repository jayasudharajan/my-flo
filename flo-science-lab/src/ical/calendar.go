...
const (
	...
	ComponentRepeatRule           ComponentProperty = "RRULE"
)
...
func (calendar *Calendar) SetRepeatRuleInterval(s string, props ...PropertyParameter) {
	calendar.setProperty(PropertyRrule, string(s), props...)
}
